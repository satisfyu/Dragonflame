...
public class ReinforcedLeatherChestplate extends DyeableArmorItem implements ICustomArmor {
    public ReinforcedLeatherChestplate(ArmorMaterial material, Properties settings) {
