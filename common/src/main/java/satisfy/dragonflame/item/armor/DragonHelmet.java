...
public class DragonHelmet extends CustomHatItem {
    public DragonHelmet(ArmorMaterial material, Properties settings) {
        super(material, Type.HELMET, settings);
    }

    @Override
    public ResourceLocation getTexture() {
        return new DragonflameIdentifier("textures/models/armor/dragon.png");
    }
