 ...
 * */
public class GroundNavigation extends GroundPathNavigation {
    @Nullable
    private BlockPos pathToPosition;

    public GroundNavigation(Mob entity, Level world) {
        super(entity, world);
    }
    ...
    protected @NotNull PathFinder createPathFinder(int maxVisitedNodes) {
        ...
        return new DRPathFinder(this.nodeEvaluator, maxVisitedNodes);
    }
