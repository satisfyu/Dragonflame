...
public class FlameParticle extends GenericParticle {
    public FlameParticle(ClientLevel world, WorldParticleEffect data, FabricSpriteProviderImpl spriteSet, double x, double y, double z, double xd, double yd, double zd) {
