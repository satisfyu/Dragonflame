...
public class ArmoredVindicatorRenderer extends MobRenderer<ArmoredVindicatorEntity, ArmoredVindicatorModel<ArmoredVindicatorEntity>> {
    ...
    public ArmoredVindicatorRenderer(EntityRendererProvider.Context context) {
        ...
        this.addLayer(new ItemInHandLayer<>(this, context.getItemInHandRenderer()) {
            @Override
            public void render(@NotNull PoseStack poseStack, @NotNull MultiBufferSource multiBufferSource, int i, @NotNull ArmoredVindicatorEntity entity, float f, float g, float h, float j, float k, float l) {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull ArmoredVindicatorEntity entity) {
        return TEXTURE;
    }
}
